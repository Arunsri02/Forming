							...
							<td data-th="Product" >
								<div class="row">
									...
									<div class="col-sm-6">
										...
										<p>Upgrade to Product today and experience the difference for yourself. Transform problem or need into desired outcome or result with our innovative solution.,</p>
										</div>
									</div>
				...
				if (!isset($_SESSION["uid"])) {
					...
					echo '
						...
						<form action="checkout.php" method="post">
							...
							<input type="hidden" name="business" value="shoppingcart@techtopia.com">
